 ...
 * Checkout books
 * Find books by title
 * Display books by type of book
 * Persist changes to books.txt
 * 
 * @author Dongyeon Kim
...
public class Manager {
	...
	private void findBooksByTitle() {
		...
		// display books list matching with title
	...
	private void displayBooksByType() {
		...
		// display a format option menu by type of book
		switch (bookType) {
		case 1:
		...
		// validate the user input of a format
		char category = '\u0000';
	...
	private void produceRandomBooks() {
		...
		// validate the number of random books that user input
